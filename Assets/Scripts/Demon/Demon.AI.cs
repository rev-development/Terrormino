	...
	public class AI : MonoBehaviour
	{
		...
		private void Start()
		{
				...
				&& PatrolPointsParent.childCount > 0)
			{
				...
				for (var i = 0; i < PatrolPointsParent.childCount; i++)
		...
		private void UpdatePatrol()
		{
			...
			if (_isMoving)
			{
				...
				var arrived = !_agent.pathPending
			...
			if (_idleTimer >= IdleTimeAtSpot) MoveToNextPatrolPoint();
		}
		...
		{
			for (var i = _patrolPoints.Length - 1; i > 0; i--)
			{
