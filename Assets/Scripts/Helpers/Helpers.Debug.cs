...
namespace Helpers
{
	...
	public static class Debug
	{
		...
		public static void InitializedWarn(bool initialized, string name, [CallerMemberName] string callerName = "")
		{
			if (!initialized) UnityEngine.Debug.Log($"{name} called {callerName} before being Initialized");
		}

		public static void InitializedWarn(
			bool initialized,
		...
		{
			if (!initialized)
				UnityEngine.Debug.Log($"{gameObject.name} called {callerName} before being Initialized", gameObject);
		}
	}
}