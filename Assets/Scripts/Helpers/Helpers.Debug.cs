...
namespace Helpers
{
    ...
    public static class Debug
    {
        ...
        public static GameObject TryFindGameObjectByName(string name)
        {
            ...
            {
                UnityEngine.Debug.LogWarning($"Could not find GameObject {name}");
            }
        ...
        public static void CheckIfSetInInspector(object toCheck, string name)
        {
            if (toCheck == null)
            {
                UnityEngine.Debug.LogWarning($"{name} not set in Inspector");
            }
        }
        ...
        public static List<T> CheckIfEmptyListInInspector<T>(List<T> toCheck, string name)
        {
            if (toCheck.Count == 0)
            {
                UnityEngine.Debug.LogWarning($"{name} is empty in Inspector");
            }
        ...
        public static GameObject TryFindByTag(string tag)
        {
            ...
            {
                UnityEngine.Debug.LogWarning($"Could not find GameObject with tag: {tag}");
            }
