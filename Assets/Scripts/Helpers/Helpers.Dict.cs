...
namespace Helpers
{
	public static class Dict
	{
		...
		{
			foreach (var keyValuePair in dictToAppend) AddOrUpdate(baseDict, keyValuePair.Key, keyValuePair.Value);
		...
		{
			foreach (var keyValuePair in dictToAppend) baseDict.TryAdd(keyValuePair.Key, keyValuePair.Value);
