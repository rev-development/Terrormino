...
public partial class @Default: IInputActionCollection2, IDisposable
{
    ...
    ~@Default()
    {
        UnityEngine.Debug.Assert(!m_Head.enabled, "This will cause a leak and performance issues, Default.Head.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_LeftHand.enabled, "This will cause a leak and performance issues, Default.LeftHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_RightHand.enabled, "This will cause a leak and performance issues, Default.RightHand.Disable() has not been called.");
    }
    ...
    public struct HeadActions
    {
        ...
        public HeadActions(@Default wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Default m_Wrapper;
        public LeftHandActions(@Default wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Default m_Wrapper;
        public RightHandActions(@Default wrapper) { m_Wrapper = wrapper; }
