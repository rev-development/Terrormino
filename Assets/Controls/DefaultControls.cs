...
public partial class @DefaultControls: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        // Dev Camera
        m_DevCamera = asset.FindActionMap("Dev Camera", throwIfNotFound: true);
    ...
    ~@DefaultControls()
    {
        UnityEngine.Debug.Assert(!m_Head.enabled, "This will cause a leak and performance issues, DefaultControls.Head.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_LeftHand.enabled, "This will cause a leak and performance issues, DefaultControls.LeftHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_RightHand.enabled, "This will cause a leak and performance issues, DefaultControls.RightHand.Disable() has not been called.");
    ...
    public struct HeadActions
    {
        ...
        public HeadActions(@DefaultControls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @DefaultControls m_Wrapper;
        public LeftHandActions(@DefaultControls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @DefaultControls m_Wrapper;
        public RightHandActions(@DefaultControls wrapper) { m_Wrapper = wrapper; }
