...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ActionBasedControllerManager : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("If true, continuous movement will be enabled. If false, teleport will enabled.")]
        ...
        [Space]
        [Header("UI Settings")]
        [SerializeField] [Tooltip("If true, UI scrolling will be enabled.")]
